...
class Job extends CFBasicRequests {
	 ...
	 * 
	 * @param string $data
	 *        	(fields that can be part of the data: title, judgments_per_unit, max_judgments_per_worker, units_per_assignment, max_judgments_per_ip, webhook_uri, send_judgments_webhook => true, payment_cents, instructions, css, js, cml)
	 ...
	 * @param string $job_id        	
	 * @param string $data
	 *        	(same attributes as described for createJob)
	 * @return Array $result (answer returned by the cURL request)
	 * @throws
	 *
	 * @link http://crowdflower.com/docs-api#jobs
	 ...
	 *        	(contains the codes for those countries) => please check the CF website for the list of codes
	 * @return Array $result (answer returned by the cURL request)
	 * @throws
	 *
	 * @link http://crowdflower.com/docs-api#jobs
	 ...
	 * @param string $job_id        	
	 * @param Array $data
	 *        	(req_ttl_in_seconds, mail_to, keywords)
	 * @return Array $result (answer returned by the cURL request)
	 * @throws
	 *
	 * @link http://crowdflower.com/docs-api#jobs
	...
	/**
	 * Set or reset the gold questions for a CrowdFlower job.
	 * Depends on the input file uploaded.
	 * 
	 * @param string $job_id        	
	 * @param Array $data
	 *        	(possible fields: reset, check, with)
	 * @return Array $result (answer returned by the cURL request)
	 * @throws
	 *
	 * @link http://crowdflower.com/docs-api#jobs
	 ...
	 * 
	 * @param string $job_id        	
	 * @param string $unitsToOrder
	 *        	count of the units to be ordered.
	 * @return Array $result (answer returned by the cURL request)
	 * @throws
	 *
	 * @link http://crowdflower.com/docs-api#jobs
